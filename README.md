...
| read the language, not lessons about it | [texts/](texts/) — twenty-eight original pieces |
| add a word | [CONTRIBUTING.md](CONTRIBUTING.md) |
| answer one of the open questions | [grammar/README.md](grammar/README.md) — and six of the forty already have [a briefing](grammar/) that measures the evidence without making the choice |
...
| [texts/](texts/) | twenty-eight original pieces — ten stories, two arguments, two dialogues, a poem, a letter, a recipe, a walk to school, a shared meal, a room, a life, a journey that may not happen and a notice on a school wall — each ending with what the language could not say |
