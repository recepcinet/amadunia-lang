...
was never there to find. The reading ladder holds a second copy of the same
detector that reads the raw line and has always worked — two copies of one
test, and only one of them right. Counted properly, the question rule stands in
fourteen texts, which would have put it seventh.
