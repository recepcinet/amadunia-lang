...
**Eighteen rules can be spotted in a sentence**, and they
...
here, four more rows are sub-rules of those pages — existence, *una*, the
command and the tone question — and **seven rules cannot be seen by a sentence
scanner at all**:
...
**A question mark is two rules, and the scan counted it as one.** Asking with
a question word — *ke*, *kim*, *nali*, *kab*, *kaifa*, *berapa* — is Lesson 07.
Asking by tone alone has been in the lessons since Lesson 01, and the syllabus
is checked for exactly that. Of the material's 259 questions, 164 use no
question word, so dating every one of them to Lesson 07 charged six lessons to
any text that asked one — both figures recounted here. They are two rows now, and the tone question stands in
more texts than the question word does.
