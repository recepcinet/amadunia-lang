...
MUTATIONS = [
    ...
    ("the front page's text count gone stale", "README.md",
     "[texts/](texts/) — twenty-seven original pieces |",
    ...
    ("a text count outside texts/ gone stale", "dictionary/frequency.md",
     "twenty-seven texts and the phrasebook", "twenty texts and the phrasebook",
    ...
    ("the ladder's flat-lesson list gone stale", "lessons/reading-ladder.md",
     ...
     "**Five lessons leave the figure unchanged: 05, 09, 11, 23 and 26.**",
    ...
    ("a fraction named with the wrong lesson", "lessons/README.md",
     "half by Lesson 08, and", "half by Lesson 06, and",
     "the ladder first reaches 50% at Lesson 08"),
    ...
    ("a briefing's corpus row gone stale", "grammar/proposal-modal-adjective.md",
     "| Amadunia sentences in the material | 1820 |",
    ...
    ("text 21's adjacent-pair rank gone stale in the index",
     "texts/README.md", "puts it twelfth of twenty-seven",
     "puts it twelfth of twenty-one",
    ...
    ("the most repeated sentence gone stale", "texts/README.md",
     "appears eight times across four files", "appears nine times across four files",
