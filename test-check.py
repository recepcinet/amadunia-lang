...
MUTATIONS = [
    ...
    ("the front page's text count gone stale", "README.md",
     "[texts/](texts/) — twenty-four original pieces |",
     "[texts/](texts/) — twenty original pieces |",
     "says 'twenty original pieces'; texts/ holds 24"),
    ...
    ("a text count outside texts/ gone stale", "dictionary/frequency.md",
     "twenty-four texts and the phrasebook", "twenty texts and the phrasebook",
     "says 'the twenty texts'; texts/ holds 24"),
    ...
    ("a briefing's corpus row gone stale", "grammar/proposal-modal-adjective.md",
     "| Amadunia sentences in the material | 1755 |",
    ...
    ("text 21's least-repetitive rank gone stale",
     ...
     "text-21 is the 7th least repetitive of 24"),
    ("text 21's adjacent-pair rank gone stale in the index",
     "texts/README.md", "puts it eleventh of twenty-four",
    ...
    ("the unmarked-clause count gone stale", "grammar/subordination.md",
     ...
     "the material holds 53 clauses with a marker and 11 without"),
