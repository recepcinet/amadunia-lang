...
MUTATIONS = [
    ...
    ("the front page's text count gone stale", "README.md",
     "[texts/](texts/) — twenty-two original pieces |",
     "[texts/](texts/) — twenty original pieces |",
     "says 'twenty original pieces'; texts/ holds 22"),
    ...
    ("a text count outside texts/ gone stale", "dictionary/frequency.md",
     "twenty-two texts and the phrasebook", "twenty texts and the phrasebook",
     "says 'the twenty texts'; texts/ holds 22"),
    ...
    ("a briefing's corpus row gone stale", "grammar/proposal-modal-adjective.md",
     "| Amadunia sentences in the material | 1697 |",
    ...
    ("the unmarked-clause count gone stale", "grammar/subordination.md",
     ...
     "the material holds 50 clauses with a marker and 11 without"),
    ...
    ("the exercise floor gone stale", "texts/README.md",
     "each stand in **at least six** texts", "each stand in **at least five** texts",
     "claims a floor of"),
