...
MUTATIONS = [
    ...
    ("the front page's text count gone stale", "README.md",
     "[texts/](texts/) — twenty-nine original pieces |",
    ...
    ("a text count outside texts/ gone stale", "dictionary/frequency.md",
     "twenty-nine texts and the phrasebook", "twenty texts and the phrasebook",
     "says 'the twenty texts'; texts/ holds"),
    ("the ladder's flat-lesson list gone stale", "lessons/reading-ladder.md",
     "**Five lessons leave the figure unchanged: 09, 11, 17, 23 and 26.**",
     "**Four lessons leave the figure unchanged: 09, 11, 23.**",
    ...
    ("text 21's adjacent-pair rank gone stale in the index",
     "texts/README.md", "puts it fourteenth of twenty-nine",
     "puts it fourteenth of twenty-one",
    ...
    ("the index's copy of the adjective-predicate figure gone stale",
     "grammar/README.md",
     "403 verbless adjective predicates", "377 verbless adjective predicates",
    ...
    ("the most repeated sentence gone stale", "texts/README.md",
     "appears eight times across five files", "appears nine times across five files",
