...
MUTATIONS = [
    ...
    ("the front page's text count gone stale", "README.md",
     "[texts/](texts/) — twenty-five original pieces |",
     "[texts/](texts/) — twenty original pieces |",
     "says 'twenty original pieces'; texts/ holds 25"),
    ...
    ("a text count outside texts/ gone stale", "dictionary/frequency.md",
     "twenty-five texts and the phrasebook", "twenty texts and the phrasebook",
     "says 'the twenty texts'; texts/ holds 25"),
    ...
    ("text 21's least-repetitive rank gone stale",
     "texts/text-21-uan-umur.md", "the seventh *least*", "the fifth *least*",
     "text-21 is the 7th least repetitive of 25"),
    ("text 21's adjacent-pair rank gone stale in the index",
     "texts/README.md", "puts it eleventh of twenty-five",
    ...
    ("the unmarked-clause count gone stale", "grammar/subordination.md",
     ...
     "the material holds 54 clauses with a marker and 11 without"),
    ...
    ("the exercise floor gone stale", "texts/README.md",
     "each stand in **at least seven** texts", "each stand in **at least five** texts",
     "claims a floor of"),
