...
MUTATIONS = [
    ...
    ("the front page's text count gone stale", "README.md",
     "[texts/](texts/) — twenty-eight original pieces |",
    ...
    ("a text count outside texts/ gone stale", "dictionary/frequency.md",
     "twenty-eight texts and the phrasebook", "twenty texts and the phrasebook",
    ...
    ("a briefing's corpus row gone stale", "grammar/proposal-modal-adjective.md",
     "| Amadunia sentences in the material | 1851 |",
    ...
    ("text 21's adjacent-pair rank gone stale in the index",
     "texts/README.md", "puts it thirteenth of twenty-eight",
     "puts it thirteenth of twenty-one",
    ...
    ("the ladder's opening figure gone stale in its own prose",
     "lessons/reading-ladder.md", "after one lesson — 22%.**",
     "after one lesson — 23%.**",
     "says 23% of the texts' words after one lesson"),
    ...
    ("the index's copy of the adjective-predicate figure gone stale",
     "grammar/README.md",
     "400 verbless adjective predicates", "377 verbless adjective predicates",
