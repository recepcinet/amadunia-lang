...
MUTATIONS = [
    ...
    ("the front page's text count gone stale", "README.md",
     "[texts/](texts/) — twenty-six original pieces |",
     "[texts/](texts/) — twenty original pieces |",
     "says 'twenty original pieces'; texts/ holds 26"),
    ...
    ("a text count outside texts/ gone stale", "dictionary/frequency.md",
     "twenty-six texts and the phrasebook", "twenty texts and the phrasebook",
     "says 'the twenty texts'; texts/ holds 26"),
    ...
    ("text 21's least-repetitive rank gone stale",
     ...
     "text-21 is the 8th least repetitive of 26"),
    ("text 21's adjacent-pair rank gone stale in the index",
     "texts/README.md", "puts it eleventh of twenty-six",
     "puts it eleventh of twenty-one",
     "11th of 26"),
    ...
    ("the gap list's three parts not adding up", "dictionary/README.md",
     "**Seven of the fifteen are joints", "**Eight of the fifteen are joints",
     "the three parts of the gap list are [3, 8, 5]"),
    ("the unmarked-clause count gone stale", "grammar/subordination.md",
     "**11 without one**", "**9 without one**",
     "the material holds 56 clauses with a marker and 11 without"),
