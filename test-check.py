...
MUTATIONS = [
    ...
    ("the front page's text count gone stale", "README.md",
     "[texts/](texts/) — twenty-three original pieces |",
     "[texts/](texts/) — twenty original pieces |",
     "says 'twenty original pieces'; texts/ holds 23"),
    ...
    ("a text count outside texts/ gone stale", "dictionary/frequency.md",
     "twenty-three texts and the phrasebook", "twenty texts and the phrasebook",
     "says 'the twenty texts'; texts/ holds 23"),
    ...
    ("text 21's least-repetitive rank gone stale",
     ...
     "text-21 is the 7th least repetitive of 23"),
    ("text 21's adjacent-pair rank gone stale in the index",
     "texts/README.md", "puts it eleventh of twenty-three",
    ...
    ("the unmarked-clause count gone stale", "grammar/subordination.md",
     ...
     "the material holds 51 clauses with a marker and 11 without"),
